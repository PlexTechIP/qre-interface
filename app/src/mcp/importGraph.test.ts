...
describe("MCP import graph validation", () => {
  ...
  it("should only import allowlisted files outside src/mcp and src/shared", () => {
    ...
    const allowlist = new Set<string>([
      ...
      // The precompiled, eval-free RunConfig validator that schemaValidation.ts
      // imports (generated by scripts/compileSchemas.mjs). It is the same schema
      // check, minus the runtime `new Function` the renderer CSP forbids — pure
      // validation code, no DOM/electron capability, so it carries nothing new.
      resolve(appDir, "src/renderer/state/runConfigValidator.generated.js"),
